...
void main() {
  testWidgets('renders four tiles with the expected labels', (tester) async {
    ...
    // Profile no longer lives in this grid — it's reached via the tappable
    // user row at the top of the drawer. The grid carries 4 destinations:
    // SAVED, DEPARTMENTS, REQUESTS, ACHIEVEMENTS.
  ...
  testWidgets('each tile fires its matching callback', (tester) async {
    var saved = 0, depts = 0, reqs = 0, achievements = 0;

...
class _MoreScreenState extends State<MoreScreen> with ScrollToTopTarget {
  ...
  static const _destinations = [
    ...
    (label: 'Saved', route: '/saved', icon: Icons.bookmark_outline),
    (label: 'Departments', route: '/departments', icon: Icons.school_outlined),
    (label: 'Requests', route: '/requests', icon: Icons.inbox_outlined),
  ];
